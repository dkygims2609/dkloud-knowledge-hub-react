...
const Index = () => {
  ...
  return (
    <div className="min-h-screen relative enhanced-landing-background">
      ...
      {/* Hero Section with Enhanced Background - Increased sizes and spacing */}
      <section className="relative py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-r from-primary/8 via-secondary/4 to-accent/8" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_hsl(var(--primary)/0.15)_0%,_transparent_70%)]" />
        </div>
        
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-40 h-96 w-96 rounded-full bg-gradient-to-br from-primary/15 to-secondary/10 blur-3xl animate-pulse" />
          <div className="absolute -bottom-40 -left-40 h-96 w-96 rounded-full bg-gradient-to-br from-accent/10 to-primary/15 blur-3xl animate-pulse" style={{animationDelay: "1s"}} />
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <div className="fade-in">
            <div className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold mb-8 slide-up" style={{animationDelay: "0.2s"}}>
              <DecodingAnimation 
            ...
            <div className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-12 bounce-in tracking-wide" style={{animationDelay: "0.3s"}}>
            ...
            <div className="text-center mb-12 fade-in max-w-3xl mx-auto" style={{animationDelay: "0.5s"}}>
            ...
            <div className="fade-in mb-12" style={{animationDelay: "0.6s"}}>
              <ColorBandSection />
            </div>
            
            <div className="flex flex-col sm:flex-row gap-8 justify-center scale-in mb-16" style={{animationDelay: "0.7s"}}>
              <Button asChild size="lg" className="neon-outline-btn text-xl px-12 py-6 h-auto">
                <Link to="/aitools">
                  Dive into dKloud Tech Universe
                  <ArrowRight className="ml-4 h-8 w-8" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="animated-border-glow text-xl px-12 py-6 h-auto">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-background via-muted/30 to-background">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="flex flex-wrap justify-center gap-4 mb-16 max-w-6xl mx-auto p-6">
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 w-full">
                {[
                  ...
                  >
                    <div className="ai-tools-card-enhanced fade-in glass-tab neon-card-hover animated-tab-gradient p-6" style={{ animationDelay: `${index * 0.1}s` }}>
                      ...
                      <div className="relative text-center">
                        <div className="text-3xl mb-4 group-hover:scale-125 transition-transform duration-500 group-hover:drop-shadow-lg flex justify-center">
                          <tab.Icon className="h-8 w-8 text-primary group-hover:text-secondary transition-colors duration-300" />
                        </div>
                        <h4 className="font-bold text-base mb-3 group-hover:text-primary transition-colors duration-300 relative text-sharp-bright">
                          {tab.name}
                        ...
                        <p className="text-sm text-muted-foreground group-hover:text-foreground transition-colors duration-300">{tab.desc}</p>
                      </div>
                    </div>
                  </Link>
                ))}
