...
const Index = () => {
  ...
  return (
    <div className="min-h-screen relative enhanced-landing-background">
      ...
      {/* Hero Section with Enhanced Background - Always Fully Open */}
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <div className="fade-in">
            <div className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 slide-up" style={{animationDelay: "0.2s"}}>
              <DecodingAnimation 
            ...
            <div className="text-xl md:text-2xl lg:text-3xl font-bold mb-10 bounce-in tracking-wide" style={{animationDelay: "0.3s"}}>
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center scale-in mb-16" style={{animationDelay: "0.7s"}}>
              <Button asChild size="lg" className="neon-outline-btn text-xl px-12 py-5">
                <Link to="/aitools">
                  Dive into dKloud Tech Universe
                  <ArrowRight className="ml-3 h-7 w-7" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="animated-border-glow text-xl px-12 py-5">
      ...
      {/* Explore Our Sections - Moved Up */}
      <section className="py-8 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-background via-muted/30 to-background">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex flex-wrap justify-center gap-4 mb-8 max-w-6xl mx-auto p-4">
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 w-full">
                {[
                  ...
                  >
                    <div className="ai-tools-card-enhanced fade-in glass-tab neon-card-hover animated-tab-gradient hover:bg-gradient-to-br hover:from-purple-600/20 hover:via-blue-500/20 hover:to-purple-800/20 transition-all duration-500" style={{ animationDelay: `${index * 0.1}s` }}>
                      ...
                      <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-transparent via-purple-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                      ...
                      <div className="relative p-5 text-center">
                        <div className="text-3xl mb-4 group-hover:scale-125 transition-transform duration-500 group-hover:drop-shadow-lg flex justify-center">
                          <tab.Icon className="h-7 w-7 text-primary group-hover:text-blue-400 transition-colors duration-300" />
                        </div>
                        <h4 className="font-bold text-base mb-3 group-hover:text-purple-300 transition-colors duration-300 relative text-sharp-bright">
                          {tab.name}
                          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-purple-500 to-blue-500 group-hover:w-full transition-all duration-500" />
                        </h4>
                        <p className="text-sm text-muted-foreground group-hover:text-blue-200 transition-colors duration-300">{tab.desc}</p>
                      </div>
                    </div>
                  </Link>
                ))}
