    ...
    <div className="min-h-screen relative enhanced-landing-background">
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_hsl(var(--primary)/0.25)_0%,_transparent_65%)]" />
        </div>
        
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-40 h-96 w-96 rounded-full bg-gradient-to-br from-primary/30 to-secondary/25 blur-3xl animate-pulse" />
          <div className="absolute -bottom-40 -left-40 h-96 w-96 rounded-full bg-gradient-to-br from-accent/25 to-primary/30 blur-3xl animate-pulse" style={{animationDelay: "1s"}} />
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] bg-gradient-radial from-primary/15 to-transparent rounded-full blur-2xl"></div>
        </div>
        
        <div className="relative max-w-7xl mx-auto text-center">
          <div className="fade-in">
            <div className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-6 slide-up" style={{animationDelay: "0.2s"}}>
              <DecodingAnimation 
            ...
            <div className="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold mb-10 bounce-in tracking-wide" style={{animationDelay: "0.3s"}}>
              <span className="hero-subtitle-enhanced font-bold tracking-wide">
                Library Of Unique Discoveries
              </span>
            </div>

            <div className="mb-10 fade-in" style={{animationDelay: "0.4s"}}>
              <AudioPlayer 
            ...
            <div className="text-center mb-10 fade-in max-w-3xl mx-auto" style={{animationDelay: "0.5s"}}>
            ...
            <div className="fade-in mb-10" style={{animationDelay: "0.6s"}}>
              <ColorBandSection />
            </div>
            
            <div className="flex flex-col sm:flex-row gap-8 justify-center scale-in mb-16" style={{animationDelay: "0.7s"}}>
              <Button asChild size="lg" className="neon-outline-btn text-xl px-12 py-6">
                <Link to="/aitools">
                  Dive into dKloud Tech Universe
                  <ArrowRight className="ml-3 h-7 w-7" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="animated-border-glow text-xl px-12 py-6">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-background via-muted/40 to-background">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="flex flex-wrap justify-center gap-4 max-w-6xl mx-auto p-6">
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 w-full">
                {[
                  ...
                  >
                    <div className="ai-tools-card-enhanced fade-in glass-tab neon-card-hover animated-tab-gradient hover:scale-110 transition-all duration-500" style={{ animationDelay: `${index * 0.1}s` }}>
                      <div className={`absolute inset-0 bg-gradient-to-br ${tab.color} opacity-0 group-hover:opacity-25 transition-opacity duration-500`} />
                      ...
                      <div className="relative p-6 text-center">
                        <div className="text-3xl mb-4 group-hover:scale-125 transition-transform duration-500 group-hover:drop-shadow-lg flex justify-center">
                          <tab.Icon className="h-8 w-8 text-primary group-hover:text-green-400 transition-colors duration-300" />
                        </div>
                        <h4 className="font-bold text-base mb-3 group-hover:text-green-400 transition-colors duration-300 relative text-sharp-bright">
                          {tab.name}
                          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-green-400 to-accent group-hover:w-full transition-all duration-500" />
                        </h4>
                        <p className="text-sm text-muted-foreground group-hover:text-green-300 transition-colors duration-300">{tab.desc}</p>
                      </div>
                    </div>
                  </Link>
                ))}
